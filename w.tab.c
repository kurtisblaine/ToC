...
#define tint 260
#define tstr 261
#define tprintint 262
#define tprintstrhoriz 263
#define tprintstrvert 264
#define tassign 265
#define tstrlit 266
#define tid 267
#define tnum 268
...
{
  "$end", "error", "$undefined", "tstart", "tfinish", "tint", "tstr",
  "tprintint", "tprintstrhoriz", "tprintstrvert", "tassign", "tstrlit",
  "tid", "tnum", "','", "';'", "'+'", "'-'", "'*'", "'/'", "'('", "')'",
  "$accept", "p", "prog", "DL", "D", "Dtail", "type", "SL", "S", "expr",
  "term", "factor", 0
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,   267,   268,    44,    59,    43,    45,    42,    47,
      40,    41
};
# endif
...
#line 132 "w.y"
    {
               ...
               else if ((yyvsp[(1) - (3)]).ttype == 20 && (yyvsp[(3) - (3)]).ttype == 10){
                          (yyval).ttype = 20;
                }
               else if ((yyvsp[(1) - (3)]).ttype == 10 && (yyvsp[(3) - (3)]).ttype == 20){
                          (yyval).ttype = 20;
                }
               else (yyval).ttype = -1;
             ;}
